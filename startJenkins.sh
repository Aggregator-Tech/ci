...
docker run -p 8080:8080 -p 50000:50000 --volumes-from aggregatortech-jenkins-dv --env JAVA_OPTS="-Dhttps.proxyHost=$proxyHost -Dhttps.proxyPort=$proxyPort -Dhttp.proxyHost=$proxyHost -Dhttp.proxyPort=$proxyPort" --name aggregatortech-jenkins jenkins/jenkins
